...
- **Multimodal Support:** Native SigLIP integration and interleaved vision/text embeddings.
- **PLE (Per-Layer Embeddings):** Integrated per-layer embedding lookup with adaptive TurboQuant dequantization for Gemma 4.
- [x] **BitNet b1.58:** Native implementation of ternary weights and BitLinear layers in GoMLX.
